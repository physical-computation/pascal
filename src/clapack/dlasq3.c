...
/* Subroutine */ int dlasq3_(integer* i0, integer* n0, doublereal* z__,
	...
	extern /* Subroutine */ int dlasq4_(integer*, integer*, doublereal*,
	                                    ...
	                                    doublereal*),
			dlasq5_(integer*, integer*, doublereal*,
...
L50:
	...
	if (*dmin__ <= 0. || *n0 < n0in) {
		if (z__[(*i0 << 2) + *pp - 3] * 1.5 < z__[(*n0 << 2) + *pp - 3]) {
			...
			*dmin2 = min(d__1, d__2);
			/* Computing MIN */
			d__1 = z__[(*n0 << 2) + *pp - 1], d__2 = z__[(*i0 << 2) + *pp - 1], d__1 = min(d__1, d__2), d__2 = z__[(*i0 << 2) + *pp + 3];
			z__[(*n0 << 2) + *pp - 1] = min(d__1, d__2);
			/* Computing MIN */
			d__1 = z__[(*n0 << 2) - *pp], d__2 = z__[(*i0 << 2) - *pp], d__1 = min(d__1, d__2), d__2 = z__[(*i0 << 2) - *pp + 4];
			z__[(*n0 << 2) - *pp] = min(d__1, d__2);
			/* Computing MAX */
			d__1 = *qmax, d__2 = z__[(*i0 << 2) + *pp - 3], d__1 = max(d__1, d__2), d__2 = z__[(*i0 << 2) + *pp + 1];
			*qmax   = max(d__1, d__2);
			*dmin__ = -0.;
		}
	}
